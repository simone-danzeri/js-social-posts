...
// Scorro gli elementi dell'array post e stampo in pagina ogni elemento
...
likesBtn.forEach((eachLikesBtn, index) => {
  eachLikesBtn.addEventListener("click", function () {
    ...
    numberOfLikes++;
    relatedLikeCounter.innerHTML = numberOfLikes;
  });
});

// FUNCTIONS
function generateSinglePost(eachPost) {
  // Estrapolo i dati dagli oggetti
  const { id, media, author, likes, created } = eachPost;
  // Stampo in pagina ogni post
  const postTemplate = `
    <div class="post">
        <div class="post__header">
            <div class="post-meta">                    
                <div class="post-meta__icon">
                    <img class="profile-pic" src="${author.image}" alt="Author">                    
                </div>
